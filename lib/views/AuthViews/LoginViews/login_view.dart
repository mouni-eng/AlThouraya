...
import 'package:althouraya/views/AuthViews/RegisterViews/registration_layout_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AuthCubit, AuthStates>(listener: (context, state) {
      if (state is LogInErrorState) {
        ...
        AlertService.showSnackbarAlert(
            "LogIn Success!", SnackbarType.success, context);
      }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            navigateTo(view: const UserRegistrationLayout(), context: context);
                          },
                          child: CustomText(
                            fontSize: width(14),
