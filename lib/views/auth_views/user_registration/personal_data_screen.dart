...
import 'package:althouraya/views/auth_views/user_login/login_view.dart';
...
import 'package:althouraya/widgets/components/rentx_imagepicker.dart';
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CustomText(
                          ...
                          fontSize: width(18),
                          fontWeight: FontWeight.w600,
                          text: cubit.signUpRequest.surname != null
                              ? cubit.signUpRequest.surname!
                              : ""),
                    ],
                  ),
                  SizedBox(
                  ...
                  Center(
                    child: CustomText(
                        ...
                        fontSize: width(16),
                        text: cubit.signUpRequest.role!.name),
                  ),
                  SizedBox(
                    height: height(21),
                  ),
                  ...
                  if (cubit.signUpRequest.role == UserRole.driver)
                    PropertiesWidget(
                        title: "Car Type",
                        onChange: (value) {
                          cubit.onChangeCarType(value);
                        }),
                  if (cubit.signUpRequest.role == UserRole.driver)
                    PropertiesWidget(
                        title: "Car Plate",
                        onChange: (value) {
                          cubit.onChangeCarPlate(value);
                        }),
                  PropertiesWidget(
                    title: "Gender type",
                    length: Gender.values.length,
                    customBuilder: (context, index) => AddTourComponent(
                      title: Gender.values[index].name,
                      selected:
                          cubit.signUpRequest.gender == Gender.values[index],
                      onSelected: () {
...
class AddTourComponent extends StatelessWidget {
  const AddTourComponent({
    Key? key,
    required this.title,
    this.selected = false,
    this.iconData,
